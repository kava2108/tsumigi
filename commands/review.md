...
- 生成した `docs/reviews/{{issue_id}}/review-checklist.md` の内容を Read する
...
- 投稿失敗時：「PR コメントの投稿に失敗しました。手動で `docs/reviews/{{issue_id}}/review-checklist.md` を共有してください」と表示する
...
- 以下を表示する：
  ...
  レビュアーへの共有:
    ...
    または docs/reviews/{{issue_id}}/ ディレクトリを共有してください。
