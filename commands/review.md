...
review_checklist_file=specs/review-checklist.md
risk_matrix_file=specs/risk-matrix.md
review_questions_file=specs/review-questions.md
...
`specs/review-checklist.md` を生成する（既存の場合は更新）。
...
`specs/review-questions.md` を生成する。
...
- 生成した `specs/review-checklist.md` の内容を Read する
...
- 投稿失敗時：「PR コメントの投稿に失敗しました。手動で `specs/review-checklist.md` を共有してください」と表示する
...
- 以下を表示する：
  ...
  生成ファイル:
    specs/review-checklist.md（N チェック項目）
    specs/risk-matrix.md     （N リスク）
    specs/review-questions.md（N 質問）
