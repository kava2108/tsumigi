...
| **T14** | [#12](https://github.com/kava2108/tsumigi/issues/12) `vckd-pipeline.yml` timeout-minutes | P1 | 🔲 未着手 | drift D5 解消 |
| **T15** | [#13](https://github.com/kava2108/tsumigi/issues/13) 中間状態ロールバック手順 | P1 | 🔲 未着手 | Q5 回答 |
